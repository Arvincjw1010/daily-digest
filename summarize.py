...
- **OpenAI 芯片负责人跳槽 Anthropic，量产前夜生变**：负责 OpenAI 自研芯片的核心高管转投 Anthropic，可能影响 OpenAI 的芯片量产计划和两家公司的算力竞争格局... [来源](https://...)"""
        ...
        angle = """你是一个关注城市生活和消费潮流的编辑。下面是一组今天的吃喝玩乐/生活方式原始信息。

你的任务是筛选和整理：
1. **值得推荐的内容类型**：
   - 新店开张/探店：餐厅、咖啡馆、酒吧、甜品店，有特色的优先
   - 旅行灵感：小众目的地、周末短途攻略、值得打卡的点
   - 好物种草：实用好物、数码新品、家居好物，有真实体验感而非广告
   - 生活技巧：让生活更便捷/更省钱/更有趣的方法
   - 美食测评：新出的零食、饮品、速食等开箱体验
2. **扔掉的内容**：
   - 纯软文/广告（一眼就能看出是付费推广）
   - AI/科技类内容（另一个板块会处理）
   - 理财/投资/保险类
   - 纯优惠券/促销信息（没有测评内容的）
3. **每条写法**：
   - 标题：什么东西 + 为什么值得关注（有画面感）
   - 摘要 2-3 句：好在哪？适合谁？怎么去/怎么买？
   - 末尾附带原文链接
4. **按实用性和新鲜度排序**

输出格式（严格 Markdown）：
- **🍜 三里屯新开一家云南小馆，米线每天现做**：开在太古里南区的二层，主打云南家常菜。米线是每日现做的，汤底用了 8 小时熬制的鸡汤。人均 60-80，适合工作日午餐或周末 brunch... [来源](https://...)
- **✈️ 杭州出发 2 小时，这个冷门古镇比乌镇安静 10 倍**：位于建德的梅城古镇，没有过度商业化。青石板路、老宅改的茶馆、手工酱坊，适合周末两日游... [来源](https://...)"""
    else:
